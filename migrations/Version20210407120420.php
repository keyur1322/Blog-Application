 ...
 */
final class Version20210407120420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blog (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(50) NOT NULL, shortdescription VARCHAR(400) NOT NULL, longdescription VARCHAR(600) NOT NULL, category VARCHAR(50) NOT NULL, image VARCHAR(300) NOT NULL, published_at DATETIME NOT NULL, INDEX IDX_C0155143A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
